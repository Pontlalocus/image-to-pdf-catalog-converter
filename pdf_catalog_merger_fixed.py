...
This script fixes the black page issue by using PyPDF2's native image handling
instead of ReportLab's ImageReader which has compatibility issues.

Usage:
    python pdf_catalog_merger_fixed.py
    python pdf_catalog_merger_fixed.py -d /path/to/images -o catalog.pdf
"""
...
class FixedPDFCatalogMerger:
    """Fixed PDF catalog merger using PyPDF2 for image handling."""
    
    def __init__(self):
        """Initialize the fixed PDF catalog merger."""
